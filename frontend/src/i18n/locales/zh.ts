export default {
  ...
  ai: {
    chat: {
      runtimeLineNotice: '当前 runtime 已接入，但还没有返回可用线路；前端不会再从本地或其他接口拼装线路。',
      responsesOnlyHint: '当前 runtime 只暴露 responses 入口，chat_completions 已按后端能力隐藏。',
      chatCompletionsHint: '仅在后端真实支持时才会下发 chat_completions。',
      recentSessions: '最近会话',
      recentSessionsHint: '刷新或分享链接后，可按 session 恢复历史消息。',
      newSession: '新会话',
      currentSession: '当前会话：',
    },
  },
  ...
  skills: {
    ...
    admin: {
      governance: {
        ...
        visibility: '可见性',
        emptyTitle: '暂无技能治理记录',
        emptyDesc: '技能进入治理流程或收到审核结果后，会出现在这里。',
        authorLabel: '作者',
        noteTitle: '最近治理备注',
        noteEmpty: '暂未记录治理备注。',
        tagsTitle: '标签',
        tagsEmpty: '当前技能还没有配置标签。',
        publishedVersionTitle: '公开版本',
        successRateTitle: '成功率',
        forcePrivateAction: '强制私有',
        disableShort: '下线',
        disableAction: '下线技能',
        detailEmpty: '选择一个技能后，这里会展示治理状态、可见性、最近审核结果和可执行动作。',
        timelineTitle: '治理时间线',
        timelineDescription: '展示技能从创建、审核、可见性变更到治理动作的主要节点。',
        timelineEmpty: '还没有选中技能。',
        toastDisabled: '技能已下线',
        toastForcePrivate: '技能已强制转私有',
        columns: {
          skillVersion: '技能',
          author: '作者',
          latestReview: '最近审核',
        ...
        metrics: {
          onlineSkills: '在线技能',
          onlineHint: '当前对用户可见且可正常执行的技能数量。',
          forcePrivate: '强制私有技能',
          forcePrivateHint: '已从公开市场移除，但仍保留私域可见的技能。',
          disabledSkills: '已下线技能',
          disabledHint: '已不再对外执行的技能数量。',
          pendingVersions: '待审版本',
          pendingHint: '还在等待最终审核结论的技能版本数。',
          requests24h: '24h 调用',
          revenue30d: '30d 收入',
        },
        labels: {
        ...
        timeline: {
          createdTitle: '技能创建',
          createdDesc: '技能已创建，并进入治理生命周期。',
          reviewTitle: '审核状态：{status}',
          reviewPendingDesc: '最新版本仍在等待审核。',
          reviewDesc: '该技能最近一次审核结果已记录。',
          visibilityTitle: '可见性：{visibility}',
          visibilityForcePrivateDesc: '当前仅保留私域可见，已退出公开市场。',
          visibilityPublicDesc: '当前在公开市场中可见。',
          visibilityPrivateDesc: '当前为私有，仅在授权范围内可见。',
          governanceTitle: '治理状态：{status}',
          governanceDisabledDesc: '技能已被下线，无法继续执行。',
          governanceForcePrivateDesc: '技能仍可私域使用，但公开曝光已关闭。',
          governanceDesc: '当前没有额外治理限制。',
        },
      },
      review: {
        title: '技能审核',
        ...
        authorLabel: '提交者',
        previousPublishedVersion: '上个公开版本',
        approveShort: '通过',
        rejectShort: '拒绝',
        approveVersion: '通过版本',
        rejectVersion: '拒绝版本',
        timelineTitle: '审核流转',
        timelineDescription: '展示当前技能版本从提交到审核结论的主要节点。',
        timelineEmpty: '还没有选中技能版本。',
        summaryTitle: '版本摘要',
        summaryEmpty: '提交方未填写版本摘要。',
        changelogTitle: '变更说明',
        changelogEmpty: '当前版本未附带变更说明。',
        tagsTitle: '标签',
        latestNoteTitle: '最近处理意见',
        detailEmpty: '选择一条待审记录后，这里会展示版本摘要、风险等级与操作入口。',
        toastApproved: '技能版本已通过审核',
        toastRejected: '技能版本已拒绝',
        columns: {
          skillVersion: '技能 / 版本',
          author: '提交者',
          status: '审核状态',
        ...
        metrics: {
          pendingVersions: '待审核版本',
          pendingHint: '当前审核队列中等待管理员处理的版本数。',
          approvedVersions: '已通过版本',
          approvedHint: '已进入后续发布或公开流程的版本。',
          rejectedVersions: '已拒绝版本',
          rejectedHint: '被驳回并需要提交方整改的版本。',
          highRiskSubmissions: '高风险提交',
          highRiskHint: '建议优先人工复核的版本。',
          requests24h: '24h 调用',
          revenue30d: '30d 收入',
          publishedVersion: '公开版本',
        },
        labels: {
          pending: '待审核',
          approved: '已通过',
        ...
        timeline: {
          submittedTitle: '版本提交',
          submittedDesc: '提交方发起新的技能版本审核。',
          queuedTitle: '进入审核队列',
          queuedHighRiskDesc: '高风险版本，建议优先处理。',
          queuedDesc: '等待审核员查看版本内容与治理规则。',
          decisionRejectedTitle: '审核拒绝',
          decisionApprovedTitle: '审核通过',
          decisionPendingTitle: '等待审核结论',
          decisionRejectedDesc: '管理员已拒绝该版本。',
          decisionApprovedDesc: '管理员已通过该版本审核。',
          decisionPendingDesc: '管理员尚未提交最终审核动作。',
          publishTitle: '后续发布 / 上线',
          publishApprovedDesc: '版本可进入主线程后续的发布、公开或灰度流程。',
          publishPendingDesc: '待审核通过后，才能进入对外发布链路。',
        },
        actionDialog: {
          subjectLabel: '操作对象',
          noSubject: '未选择技能',
          titleApprove: '通过技能版本审核',
          titleReject: '拒绝技能版本审核',
          titleDisable: '下线技能',
          titleForcePrivate: '强制转私有',
          descApprove: '通过后该版本可进入后续发布或公开流程。',
          descReject: '拒绝时请说明原因，便于提交方按意见重新提审。',
          descDisable: '下线后技能将不可继续对外运行，请保留治理依据。',
          descForcePrivate: '强制转私有后技能将退出公开市场，仅保留私域可见。',
          notesLabelDestructive: '处理说明',
          notesLabelApprove: '审核备注',
          placeholderApprove: '可选：记录审核结论、注意事项或上线要求',
          placeholderReject: '请输入拒绝原因、整改建议或风险说明',
          placeholderDisable: '请输入下线原因、触发规则或处置依据',
          placeholderForcePrivate: '请输入强制转私有原因、风险点或投诉线索',
          hintDestructive: '拒绝/下线/强制私有建议填写可追踪的治理依据。',
          hintApprove: '备注会进入审核日志。',
          confirmApprove: '确认通过',
          confirmReject: '确认拒绝',
          confirmDisable: '确认下线',
          confirmForcePrivate: '确认转私有',
          validationRequired: '请填写处理依据后再提交。',
        },
      },
      runtime: {
        title: '运行监控',
        subtitle: '基于真实运行数据监控技能执行、队列压力和告警。',
        searchPlaceholder: '搜技能名、slug、版本',
        healthStatus: '健康状态',
        summaryNote: '指标由真实运行数据聚合而成。',
        view: '查看',
        emptyTitle: '暂无运行监控数据',
        emptyDescription: '技能运行指标、告警和队列信息会展示在这里。',
        columns: {
          skillName: '技能 / 版本',
          skillVersion: '技能 / 版本',
          healthStatus: '健康',
        ...
        metrics: {
          activeSkills: '活跃技能',
          requests24h: '24h 请求',
          totalSkills: '总技能 {count}',
          averageSuccessRate: '平均成功率',
          p95Latency: 'P95 延迟',
          criticalAlerts: '严重告警',
          requestsHint: '按当前筛选窗口统计',
          warningCount: '预警 {count}',
          latencyHint: '延迟升高时优先排查队列和依赖',
          criticalHint: '优先处理影响线上可用性的技能'
        },
        detail: {
          successRate: '成功率',
          p95Latency: 'P95 延迟',
          ...
          lastAlertAt: '最近告警',
          lastError: '最近错误',
          noRecentError: '当前技能没有最近错误记录。',
          selectionPlaceholder: '选择一条技能运行记录后，这里会展示延迟、错误和队列指标。',
          noSelection: '选择一条技能运行记录后，这里会展示延迟、错误和队列指标。'
        },
        events: {
          title: '最近告警 / 事件',
          description: '默认展示全局事件；选中技能后优先过滤关联事件。',
          empty: '当前没有告警事件。',
          global: '全局事件'
        },
        health: {
      ...
      settlement: {
        ...
        status: '结算状态',
        filterHint: '按结算状态筛选，聚焦待审核、待打款或已完成结算的记录。',
        emptyTitle: '暂无结算记录',
        emptyDesc: '技能产生收入并进入结算周期后，会在这里展示结算记录。',
        authorLabel: '作者',
        periodTitle: '结算周期',
        payoutTitle: '应结金额',
        grossTitle: '总流水',
        platformFeeTitle: '平台抽成',
        frozenTitle: '冻结金额',
        updatedTitle: '最近更新',
        noteTitle: '结算备注',
        noteEmpty: '暂未记录结算备注。',
        detailEmpty: '选择一条结算记录后，这里会展示金额、费用、时间线和审核备注。',
        timelineTitle: '结算时间线',
        timelineDescription: '展示收入从累计、审核、进入待打款到最终结算完成的主要节点。',
        timelineEmpty: '还没有选中结算记录。',
        columns: {
          skill: '技能',
          author: '作者',
          period: '周期',
        ...
        metrics: {
          pendingAmount: '待结金额',
          pendingHint: '有 {count} 个技能仍在等待审核或进入待打款阶段。',
          settledAmount: '已结金额',
          settledHint: '已发放给创作者的结算金额。',
          frozenAmount: '冻结金额',
          frozenHint: '因审核、争议或风险复核而暂时冻结的金额。',
          currency: '结算币种',
          currencyHint: '统计口径按当前结算币种汇总。',
        },
        labels: {
          pending: '待审核',
          ready: '待打款',
        ...
        timeline: {
          accrualTitle: '收入累计',
          accrualDesc: '{period} 的收入已汇总进入本次结算周期。',
          auditTitle: '结算审核',
          auditDesc: '结算记录已通过审核，等待进入打款阶段。',
          auditFrozenTitle: '结算冻结',
          auditFrozenDesc: '结算记录当前处于冻结状态，等待人工复核或问题处理。',
          auditRejectedTitle: '结算驳回',
          auditRejectedDesc: '结算记录在审核阶段被驳回。',
          readyTitle: '待打款',
          readyDesc: '结算记录已通过审核，可进入创作者打款流程。',
          readyPendingTitle: '等待进入待打款',
          readyPendingDesc: '结算记录尚未进入待打款阶段。',
          settledTitle: '结算完成',
          settledDesc: '打款已完成并记录入账。',
          settledPendingTitle: '等待最终结算',
          settledPendingDesc: '当前还未完成最终打款结算。',
        },
      }
    },
    card: {
    ...
    labels: {
      typePromptChat: '对话提示词',
      typePromptImage: '图像提示词',
      typeScript: '脚本',
      statusDraft: '草稿',
      statusPublished: '已发布',
      statusArchived: '已归档',
      ...
      runStatusSucceeded: '成功',
      runStatusFailed: '失败',
      runStatusCancelled: '已取消',
      versionStatusDraft: '草稿',
      versionStatusPublished: '已发布',
      versionStatusArchived: '已归档',
      versionStatusDeprecated: '已废弃',
  ...
  auth: {
    ...
    oauthFlow: {
      ...
      wechatNativeAppOnly: '当前微信登录流程仅支持从原生移动应用发起。',
  ...
  usage: {
    ...
    imageSizeLegacyUnstandardized: '历史非标准尺寸',
    imageSizeUnknown: '未知',
    imageTotalPrice: '图片总价',
    imageSubtotal: '图片小计',
    tokenSubtotal: 'Token 小计',
    rowTotal: '当前行总额',
    imageCount: '图片张数',
    cacheRead: '读取',
    cacheWrite: '写入',
  ...
  admin: {
    ...
    backup: {
      ...
      s3: {
        ...
        backupTitle: '备份存储',
        backupProfile: '备份使用的存储',
        backupProfileRequired: '请选择备份使用的存储配置',
        selectProfile: '请选择存储配置',
        mediaTitle: '媒体上传',
        mediaDescription: '发票文件、头像、公告图片、工单图片等媒体上传将共用这套对象存储配置。',
        mediaEnabled: '启用媒体存储',
        mediaProfile: '媒体使用的存储',
        mediaProfileRequired: '启用媒体存储时请选择媒体使用的存储配置',
        mediaPublicBaseURL: '媒体公开访问域名',
        mediaPublicBaseURLRequired: '启用媒体存储时必须填写媒体公开访问域名',
        mediaPrefix: '媒体对象前缀',
        testConnection: '测试连接',
    ...
    groups: {
      ...
      openaiTypeRequired: '请至少选择一种生图类型',
      tier1k: '1K',
      tier2k: '2K',
      tier4k: '4K',
      tier1kPrice: '1K（美元）',
    ...
    riskControl: {
      ...
      apiKeysPlaceholder: "新增 API Key，每行一个；可写成 sk-... email{'@'}example.com，保存后会追加到已保存 Key",
      apiKeysPlaceholderReplace: "覆盖保存 API Key，每行一个；可写成 sk-... email{'@'}example.com，保存后会替换全部已保存 Key",
      apiKeysPlaceholderKeep: "新增 API Key，每行一个；可写成 sk-... email{'@'}example.com，保存后会追加到已保存 Key",
      ...
      retryCount: '失败重试次数',
      apiKeyRateLimitPolicy: '审核 Key 限流异常策略',
      apiKeyRateLimitPolicyHint: '当所有审核 Key 被本地限流或上游返回 429 时生效；标记异常会在前置拦截中报错给客户端，放行则继续原请求。',
      apiKeyRateLimitPolicyError: '标记异常并返回客户端',
      apiKeyRateLimitPolicyAllow: '放行原请求',
      apiKeyRPMLimit: '单 Key 每分钟请求数',
      apiKeyRPDLimit: '单 Key 每日请求数',
      apiKeyTPMLimit: '单 Key 每分钟 Token 数',
      apiKeyLocalUsage: '本地用量 RPM {rpm} / RPD {rpd} / TPM {tpm}',
      sampleRate: '采样率',
      recordNonHits: '记录未命中输入',
      recordNonHitsHint: '开启后会记录抽样但未命中的请求摘要，摘要会先脱敏再入库。',
      recordAttentionInputs: '开启记录需关注阈值',
      recordAttentionInputsHint: '未命中但最高分达到该阈值时，只作为未命中摘要入库，不触发命中、封禁或拦截。',
      attentionThreshold: '需关注阈值',
      attentionThresholdInvalid: '开启记录需关注阈值时，需关注阈值必须大于 0 且小于等于 100。',
      ...
      autoBanExemptUsersPlaceholder: "每行一个用户 ID 或邮箱\n1001\nvip{'@'}example.com",
      autoBanExemptUsersSearchPlaceholder: '按邮箱或 ID 搜索用户',
      autoBanExemptUserUnknownEmail: '邮箱缺失',
      autoBanExemptUsersHint: '这些用户命中后仍会被拦截并发送邮件，但不会被自动封禁。',
      ...
      blockedKeywordsPlaceholder: '每行输入一个关键词或规则，例如：\n敏感词1\n完整风险话术\n账号 && 出售',
      blockedKeywordsDescription: '匹配忽略大小写；同一行使用 && 分隔时，所有片段都出现才算命中；命中后会按下方策略决定是否调用上游审计接口。',
    ...
    channelMonitor: {
      ...
      adjustAvailability: {
        ...
        target: '目标可用率',
        placeholder: '0 - 100',
        hint: '会直接调整最近 7 天主模型历史明细。由于样本数量限制，最终值可能只能贴近目标百分比。',
        submit: '应用',
        invalid: '可用率必须在 0 到 100 之间',
        failed: '调整可用率失败',
        success: '可用率已调整到 {value}，修改 {rows} 条历史明细'
      },
      columns: {
        name: '名称',
        provider: '供应商',
    ...
    subscriptions: {
      ...
      quotaEndsInMinutes: '额度 {minutes} 分钟后结束',
      quotaEndsInHoursMinutes: '额度 {hours} 小时 {minutes} 分钟后结束',
      quotaEndsInDaysHours: '额度 {days} 天 {hours} 小时后结束',
    ...
    accounts: {
      ...
      responseRewrite: {
        title: '响应改写规则',
        hint: '仅适用于 OpenAI。命中规则时，只改写最终返回给客户端的错误文案。',
        notice: '规则基于上游原始状态码和响应体文本匹配。账号规则优先于全局透传规则。',
        addRule: '添加改写规则',
        ruleIndex: '规则 #{index}',
        statusCode: '状态码',
        statusCodePlaceholder: '可选，例如 503',
        matchMode: '匹配方式',
        matchModeAny: '命中任一条件',
        matchModeAll: '命中全部条件',
        keywords: '关键词',
        keywordsPlaceholder: '可选，例如 insufficient_quota, too many requests',
        keywordsHint: '多个关键词用逗号分隔，匹配时不区分大小写。',
        responseMessage: '响应文案',
        responseMessagePlaceholder: '返回给客户端的文案',
        description: '描述',
        descriptionPlaceholder: '可选，便于内部备注',
        rulesInvalid: '请至少填写一条有效的改写规则，或清空未完成的条目。'
      },
      usageWindow: {
      ...
      inviteResetSubtitle: '邀请好友使用 Codex 并管理该账号的重置次数',
      inviteResetOpenDialog: '打开邀请重置弹窗',
      inviteResetCountShort: '重置次数',
      inviteResetQuery: '查询',
      inviteResetReset: '重置',
      inviteResetRefresh: '刷新',
      inviteResetAvailable: '可用重置次数',
      inviteResetAvailableUnit: '次',
      inviteResetCreditFallbackTitle: 'Codex 重置次数',
      inviteResetCreditFallbackDescription: '可用于重置当前 Codex 用量窗口',
      inviteResetNoCredits: '当前没有可用的重置次数',
      inviteResetRules: '邀请规则',
      inviteResetRulesEmpty: '暂无可展示的规则',
      inviteResetInviteEmails: '邀请邮箱',
      inviteResetPlaceholder: '输入邮箱，使用逗号、空格或换行分隔',
      inviteResetEmailHint: '一次最多邀请 {max} 个邮箱',
      inviteResetConsent: '我确认已获得这些收件人同意，可以向其发送 Codex 邀请邮件',
      inviteResetSendInvite: '发送邀请',
      inviteResetSending: '发送中...',
      inviteResetEmailsRequired: '请至少输入一个邮箱地址',
      inviteResetInvalidEmail: '无效的邮箱地址：{email}',
      ...
      inviteResetAlreadyRedeemed: '该重置次数已被使用',
      inviteResetNoCredit: '没有可用的重置次数',
      inviteResetHistoryTitle: '历史记录',
      inviteResetHistoryEmpty: '暂无邀请/重置记录',
      inviteResetHistoryActionInvite: '邀请',
      inviteResetHistoryActionConsume: '重置',
      inviteResetHistorySuccess: '成功',
      inviteResetHistoryFailed: '失败',
      inviteResetHistoryFailedEmails: '失败邮箱：{emails}',
      tier: {
        free: 'Free',
        pro: 'Pro',
        ultra: 'Ultra',
      ...
      accountNameOAuthPlaceholder: 'OAuth 可留空，授权后自动使用 email (profile_id)',
      ...
      openai: {
        ...
        codexCLIOnlyAllowClaudeCode: '允许 Claude Code Codex 插件',
        codexCLIOnlyAllowClaudeCodeDesc: '开启仅允许 Codex 官方客户端时，同时放行识别为 Claude Code Codex 插件的请求。',
        ...
        responsesMode: '文本生成协议',
        responsesModeDesc:
          '控制 API Key 文本请求优先走 Responses API 还是 Chat Completions。自动模式跟随网关能力探测。',
        responsesModeAuto: '自动',
        responsesModeForceResponses: '强制 Responses',
        responsesModeForceChatCompletions: '强制 Chat Completions',
        responsesModeTextDisabledHint: '该账号未启用文本生成能力，因此协议覆盖不适用。',
        endpointCapabilities: '允许的端点能力',
        endpointCapabilitiesDesc: '限制该 OpenAI-compatible API Key 账号可承载的端点；至少保留一项能力。',
        endpointCapabilityChatCompletions: '文本生成',
        endpointCapabilityEmbeddings: 'Embeddings',
        textEndpointAutoRoute: '文本端点自动转换',
        textEndpointAutoRouteDesc:
          '允许 Responses、Messages、Chat Completions 文本入口自动转换到该账号可用的文本上游端点。用于 Chat-only 上游承载 Codex /responses 或 /messages 请求。',
      ...
      oauth: {
        ...
        gemini: {
          ...
          ineligibleTier:
            'Gemini 授权失败：当前 Google 账号不符合所选 OAuth 套餐的上游资格要求。',
          eligibilityGuidanceTitle: '失败原因与处理方式',
          ineligibleTierGuidanceTitle: '资格校验未通过',
          eligibilityAgeReason:
            '原因：上游资格检查仍把当前 Google 账号判定为年龄受限，或年龄验证尚未生效。如果你已经完成年龄验证，最常见的原因是 OAuth 弹窗里登录的不是同一个账号，或者 Google 的资格状态还没有同步到这条授权链路。',
          ineligibleTierReason:
            '原因：上游 Gemini OAuth 登录本身成功了，但当前 Google 账号不具备所选 Gemini 套餐的使用资格。这是上游账号状态问题，不是本地请求格式问题。',
          eligibilityStepCheckAccount:
            '先检查当前 Google 账号资料和资格状态，并确认你授权的是正确的那个 Google 账号。',
          eligibilityAgeStepRetryAuth:
            '如果你已经完成年龄验证，请先退出 Google，再在 OAuth 弹窗里重新登录同一个个人 Google 账号，等待上游状态同步后，重新生成授权链接再试一次。',
          eligibilityAgeStepTryOtherFlow:
            '如果同一个 Google One 账号重试后仍失败，就不要继续卡在当前账号上，直接换一个已经满足条件的个人 Google 账号。',
          eligibilityGenericStepRetryAuth:
            '先退出 Google，再在 OAuth 弹窗里重新登录你真正要授权的那个账号，重试一次，先排除账号切换或上游会话状态陈旧的问题。',
          eligibilityGenericStepTryOtherFlow:
            '如果仍失败，就检查上游限制，例如账号类型、Workspace 策略、所在国家或地区、网络环境；必要时直接换一个明确符合条件的 Google 账号。',
          eligibilityAgeNotGcpRelated:
            '这类报错不是因为 GCP Project ID、IAM 角色或 Cloud AI Companion API 缺失导致的。下方的 GCP 项目说明和链接，只用于项目引导或 project_id 自动探测失败的场景。',
          ...
          projectTipStepApi: '在该项目里启用 cloudaicompanion.googleapis.com。',
          projectConsoleLink: '打开 Google Cloud Console',
          projectApiLink: '启用 Cloud AI Companion API',
          projectIdRecoveryTitle: '自动探测失败后手动填写 Project ID',
          projectIdRecoveryDesc:
            '填写你刚准备好的 Project ID，然后重新生成授权链接并再次完成 Google 授权。',
          legacyCustomOAuthRemoved: '旧版 AI Studio OAuth 已下线',
          legacyCustomOAuthRemovedDesc:
            '自建 OAuth Client 授权入口已移除，旧版 AI Studio OAuth 账号不再支持重新授权。请改用 Gemini API Key，或新建 Google One / GCP Code Assist OAuth 账号。'
        },
      ...
      kiro: {
        ...
        authMethodHint: '社交登录适合常规 Kiro 账号；IDC 需要额外的 AWS/IDC 客户端参数。',
        ...
        quotaPartSummary: '${used}/${limit} · 剩余 ${remaining}',
        monthlyQuota: '每月',
        bonusQuota: '赠送',
        freeTrialQuota: '试用'
      },
      ...
      imageTestRouteLabel: '测试路径',
      imageTestRouteHint: 'OpenAI 生图测试固定使用 codex。',
    ...
    ops: {
      ...
      systemLogs: {
        ...
        loadFailed: '系统日志加载失败',
        saveConfigSuccess: '日志运行时配置已生效',
        saveConfigFailed: '保存日志配置失败',
        resetConfirm: '确认回滚为启动配置（env/yaml）并立即生效？',
        resetConfigSuccess: '已回滚到启动日志配置',
        resetConfigFailed: '回滚日志配置失败',
      ...
      settings: {
        ...
        ignoreCredential401Errors: '忽略 401 凭证失效错误',
        ignoreCredential401ErrorsHint: '启用后，401 凭证失效/认证失败类错误将不会写入错误日志。',
        ignoreRateLimit429Errors: '忽略 429 限流错误',
        ignoreRateLimit429ErrorsHint: '启用后，429 限流类错误将不会写入错误日志。',
        ignoreAccountNotFoundErrors: '忽略 Account not found 错误',
        ignoreAccountNotFoundErrorsHint: '启用后，Account not found 类错误将不会写入错误日志，适合清理定时测试噪音。',
        autoRefresh: '自动刷新',
        enableAutoRefresh: '启用自动刷新',
        ...
        validation: {
          title: '请修复以下问题',
          retentionDaysRange: '保留天数必须在 0-365 天之间（0 = 每次清理都清空历史）',
          slaMinPercentRange: 'SLA 最低百分比必须在 0 到 100 之间',
          ttftP99MaxRange: 'TTFT P99 最大值必须为大于等于 0 的数字',
          requestErrorRateMaxRange: '请求错误率最大值必须在 0 到 100 之间',
          upstreamErrorRateMaxRange: '上游错误率最大值必须在 0 到 100 之间',
          openaiQuotaAutoPauseRange: 'OpenAI 账号配额自动暂停阈值必须在 0 到 100 之间'
        }
      },
      concurrency: {
        title: '并发 / 排队',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          rebateCap: '单笔返利上限',
          rebateCapHint: '单次充值可产生的最大返利额度，0 表示不限制。',
          inviteeLimit: '单个邀请人可计返利人数上限',
          inviteeLimitHint: '最多可计入返利的被邀请人数，0 表示不限制。',
          signupBonus: '被邀请人注册奖励',
          signupBonusHint: '被邀请用户完成注册后发放的奖励额度，0 表示不发放。',
      ...
      emailTemplates: {
        ...
        html: 'HTML 内容',
        htmlPlaceholder: '请输入邮件 HTML 内容',
        placeholders: '占位符',
        placeholdersHelp: '点击占位符可复制到模板中。',
        livePreview: '实时预览',
        noPreview: '暂无预览',
        customized: '已自定义',
        previewSecurityHint: '预览在浏览器沙箱中展示，不执行脚本。',
        validationRequired: '邮件主题和 HTML 内容不能为空。',
        saveSuccess: '邮件模板已保存。',
        restoreConfirm: '确定恢复为官方默认模板吗？',
      ...
      gatewayForwarding: {
        ...
        debugTimelineDirectoryHint: '相对路径基于服务工作目录；日志文件按日期命名为 gateway-timeline-YYYY-MM-DD.log。',
        debugTimelineRetentionDays: '保留天数',
        debugTimelineMaxSizeMB: '最大占用 MB',
        debugTimelineIncludeBody: '记录请求/响应正文',
        debugTimelineIncludeBodyHint: '只对 Claude 与 Kiro 平台生效。开启后会把请求体、上游请求体、上游响应体（流式聚合）写入时间线，便于排查工具调用、缓存模拟等问题。Authorization、refresh_token、client_secret 等敏感字段会自动脱敏。',
        debugTimelineBodyMaxKB: '单条正文上限 KB',
        debugTimelineBodyMaxKBHint: '单条正文超过此上限会被截断并标记 body_truncated。默认 32KB，最大 1024KB。',
        ...
        openaiAllowClaudeCodeCodexPlugin: '允许 Claude Code Codex 插件',
        openaiAllowClaudeCodeCodexPluginDesc:
          '全局开关。开启客户端限制时，允许 OpenAI Codex 路由接受 Claude Code Codex 插件流量。',
      },
      webSearchEmulation: {
        title: 'Web Search 模拟',
    ...
    tlsFingerprintProfiles: {
      ...
      form: {
        ...
        userAgent: 'User-Agent',
        userAgentPlaceholder: '例如 codex_exec/0.141.0 (Ubuntu 24.4.0; x86_64) WindowsTerminal',
        userAgentHint: '可选。填写后，OpenAI 使用该 TLS 模板时会同步使用这个上游 User-Agent；留空则按透传和 OpenAI Codex UA 设置回退。',
    ...
    tlsFingerprintRouters: {
      title: 'TLS 指纹路由器',
      description: '按入站 OpenAI User-Agent 匹配 TLS 指纹模板，并可覆盖上游请求头',
      createRouter: '创建路由器',
      editRouter: '编辑路由器',
      deleteRouter: '删除路由器',
      noRouters: '暂无路由器',
      createFirstRouter: '创建你的第一个 TLS 指纹路由器',
      ruleCount: '{count} 条规则',
      ...
      form: {
        name: '路由器名称',
        namePlaceholder: '例如 OpenAI User-Agent 路由器',
        description: '描述',
        descriptionPlaceholder: '可选的路由器描述',
        enabled: '启用路由器',
        enabledHint: '禁用后账号不会使用此路由器规则',
        rules: '规则',
        addRule: '添加规则',
        ...
        upstreamUserAgentPlaceholder: '可选的替换 User-Agent',
        upstreamOriginator: '上游 Originator',
        upstreamOriginatorPlaceholder: '可选的 originator 值'
      },

      deleteConfirmMessage: '确定要删除路由器 "{name}" 吗？使用此路由器的账号将停止按 TLS 指纹规则路由。',
      createSuccess: '路由器创建成功',
      updateSuccess: '路由器更新成功',
      deleteSuccess: '路由器删除成功',
      loadFailed: '加载路由器失败',
      saveFailed: '保存路由器失败',
      deleteFailed: '删除路由器失败',
      toggleFailed: '切换路由器状态失败'
    }
  },
  ...
  payment: {
    ...
    invoice: {
      ...
      detailPage: {
        relatedOrders: '关联订单',
        fileWaiting: '等待财务开具发票',
      },
      create: {
        action: '申请开票',
        selected: '已选 {count} 笔订单',
        totalAmount: '合计金额',
        submit: '提交申请',
        submitting: '提交中…',
        success: '发票申请已提交',
        allSuccess: '发票申请已提交',
        clearSelection: '清除选择',
        maxExceeded: '最多选择 100 笔订单',
      },
      list: {
        title: '我的发票',
        empty: '暂无发票',
        colOrderCount: '订单数',
        searchPlaceholder: '搜索发票号、抬头、邮箱、订单号…',
      },
      errors: {
        INVOICE_ORDER_INELIGIBLE: '以下订单不可开票，请刷新后重试',
        INVOICE_ALREADY_INVOICED: '订单已在另一张发票中',
        INVOICE_BATCH_TOO_MANY: '最多选择 100 笔订单',
        INVOICE_CANNOT_CANCEL: '当前状态不可取消',
        INVOICE_CANNOT_UPLOAD: '当前状态不可上传',
        INVOICE_NOT_ISSUED: '发票未开具',
        INVOICE_DISABLED: '该订单不支持开票',
        INVOICE_TITLE_REQUIRED: '请填写发票抬头',
        INVOICE_TAX_NUMBER_REQUIRED: '请填写税号',
        INVOICE_EMAIL_REQUIRED: '请填写接收邮箱',
        INVOICE_FILE_REQUIRED: '请选择发票文件',
        INVOICE_NOT_FOUND: '发票不存在',
        INVOICE_SERVICE_UNAVAILABLE: '发票服务暂不可用',
      },
    },
    ...
    admin: {
      ...
      forceRefund: '我已确认风险并继续退款',
      invoiceRefundAppliedWarning: '该订单已有发票申请，退款会取消发票申请，请管理员确认后继续退款。',
      invoiceRefundIssuedWarning: '该订单已开具发票，退款需要财务红冲/开具红字发票，请管理员确认后继续退款。',
