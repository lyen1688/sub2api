export default {
  ...
  common: {
    ...
    upload: 'Upload',
    remove: 'Remove',
    fileTooLarge: 'File size must be {maxSize}MB or smaller',
    selectImageFile: 'Please select an image file',
    jsonFileFormat: 'JSON (.json)',
  ...
  ai: {
    chat: {
      runtimeLineNotice:
        'The current runtime is connected, but it has not returned any available lines yet. The frontend will not assemble lines from local state or other APIs.',
      responsesOnlyHint:
        'The current runtime only exposes the responses entry; chat_completions is hidden based on backend capabilities.',
      chatCompletionsHint:
        'chat_completions is only offered when the backend actually supports it.',
      recentSessions: 'Recent Sessions',
      recentSessionsHint: 'After refreshing or sharing the link, you can restore history by session.',
  ...
  skills: {
    ...
    actions: {
      ...
      publish: 'Publish',
      testSuccess: 'Test run started',
      useSuccess: 'Run started',
      submitReviewSuccess: 'Version submitted for review',
      publishSuccess: 'Version published successfully',
      alreadyCurrent: 'This version is already current.',
      currentPublishedHint: 'This version is already live. You can continue testing or using it.',
      currentUnavailable: 'This version is currently unavailable for this action.',
      pendingReviewHint: 'This version is under review and cannot be tested, used, or published yet.',
      publishReadyHint: 'This version has been approved and is ready to publish.',
      submitRequiredHint: 'Submit this version for review before publishing it.',
      requiresApprovedVersion: 'This version has not been approved yet and cannot be tested, used, or published.'
    },
    admin: {
      governance: {
        title: 'Skill Governance',
        searchPlaceholder: 'Search by skill name, author, or slug',
        status: 'Governance Status',
        latestReview: 'Latest Review',
        visibility: 'Visibility',
        emptyTitle: 'No skill governance records',
        emptyDesc: 'Skills will appear here once they enter governance workflows or receive review results.',
        authorLabel: 'Author',
        noteTitle: 'Latest Governance Note',
        noteEmpty: 'No governance note recorded yet.',
        tagsTitle: 'Tags',
        tagsEmpty: 'No tags configured for this skill yet.',
        publishedVersionTitle: 'Published Version',
        successRateTitle: 'Success Rate',
        forcePrivateAction: 'Force Private',
        disableShort: 'Disable',
        disableAction: 'Disable Skill',
        detailEmpty:
          'Select a skill to view its governance status, visibility, latest review result, and available actions.',
        timelineTitle: 'Governance Timeline',
        timelineDescription: 'Shows the main milestones across creation, review, visibility, and governance actions.',
        timelineEmpty: 'No skill selected yet.',
        toastDisabled: 'Skill disabled',
        toastForcePrivate: 'Skill forced private',
        columns: {
          skillVersion: 'Skill',
          author: 'Author',
          latestReview: 'Latest Review',
        ...
        metrics: {
          ...
          onlineHint: 'Skills currently visible to users and available for normal execution.',
          forcePrivate: 'Force-Private Skills',
          forcePrivateHint: 'Skills removed from the public marketplace but still retained privately.',
          disabledSkills: 'Disabled Skills',
          disabledHint: 'Skills that are no longer available for public execution.',
          pendingVersions: 'Pending Reviews',
          pendingHint: 'Skill versions still waiting for a final review decision.',
          requests24h: '24h Requests',
          revenue30d: '30d Revenue',
        },
        labels: {
        ...
        timeline: {
          ...
          createdDesc: 'The skill has been created and entered the governance lifecycle.',
          reviewTitle: 'Review Status: {status}',
          reviewPendingDesc: 'The latest version is still waiting for review.',
          reviewDesc: 'The latest review result has been recorded for this skill.',
          visibilityTitle: 'Visibility: {visibility}',
          visibilityForcePrivateDesc:
            'The skill is only available privately and has been removed from the public marketplace.',
          visibilityPublicDesc: 'The skill is currently visible in the public marketplace.',
          visibilityPrivateDesc: 'The skill is currently private and only visible within permitted scopes.',
          governanceTitle: 'Governance Status: {status}',
          governanceDisabledDesc: 'The skill has been disabled and is no longer available for execution.',
          governanceForcePrivateDesc:
            'The skill remains available privately, but public exposure has been disabled.',
          governanceDesc: 'No extra governance restrictions are currently applied.',
        },
      },
      review: {
        title: 'Skill Review',
        searchPlaceholder: 'Search by skill name, version, or author',
        status: 'Review Status',
        riskLevel: 'Risk Level',
        visibility: 'Visibility',
        emptyTitle: 'No skill versions awaiting review',
        emptyDesc: 'Submitted skill versions will appear here in the review queue.',
        authorLabel: 'Author',
        previousPublishedVersion: 'Previous published version',
        approveShort: 'Approve',
        rejectShort: 'Reject',
        approveVersion: 'Approve Version',
        rejectVersion: 'Reject Version',
        timelineTitle: 'Review Timeline',
        timelineDescription: 'Shows the main milestones from submission to review decision.',
        timelineEmpty: 'No skill version selected yet.',
        summaryTitle: 'Version Summary',
        summaryEmpty: 'The submitter did not provide a version summary.',
        changelogTitle: 'Changelog',
        changelogEmpty: 'This version does not include a changelog.',
        tagsTitle: 'Tags',
        latestNoteTitle: 'Latest Review Note',
        detailEmpty: 'Select a pending review to see the version summary, risk level, and actions.',
        toastApproved: 'Skill version approved',
        toastRejected: 'Skill version rejected',
        columns: {
        ...
        metrics: {
          ...
          pendingHint: 'Versions currently waiting in the review queue.',
          approvedVersions: 'Approved Versions',
          approvedHint: 'Versions that can proceed to publish or public release.',
          rejectedVersions: 'Rejected Versions',
          rejectedHint: 'Versions sent back for fixes or additional review.',
          highRiskSubmissions: 'High-Risk Submissions',
          highRiskHint: 'Submissions that should be manually reviewed first.',
          requests24h: '24h Requests',
          revenue30d: '30d Revenue',
        ...
        timeline: {
          submittedTitle: 'Version Submitted',
          submittedDesc: 'The submitter created a new skill version review request.',
          queuedTitle: 'Queued for Review',
          queuedHighRiskDesc: 'High-risk version. Prioritize manual review.',
          queuedDesc: 'Waiting for reviewers to inspect version content and governance rules.',
          decisionRejectedTitle: 'Review Rejected',
          decisionApprovedTitle: 'Review Approved',
          decisionPendingTitle: 'Awaiting Review Decision',
          decisionRejectedDesc: 'An administrator rejected this version.',
          decisionApprovedDesc: 'An administrator approved this version.',
          decisionPendingDesc: 'No final review action has been submitted yet.',
          publishTitle: 'Publish / Rollout',
          publishApprovedDesc: 'The version can now proceed to publish, public release, or staged rollout.',
          publishPendingDesc: 'The version cannot proceed to release until it passes review.',
        },
        actionDialog: {
          subjectLabel: 'Subject',
          noSubject: 'No skill selected',
          titleApprove: 'Approve Skill Version',
          titleReject: 'Reject Skill Version',
          titleDisable: 'Disable Skill',
          titleForcePrivate: 'Force Private',
          descApprove: 'After approval, this version can proceed to publish or public release.',
          descReject: 'Explain the reason so the submitter can revise and resubmit.',
          descDisable: 'Disabling the skill stops public execution. Keep a traceable governance reason.',
          descForcePrivate: 'Forcing private removes the skill from the public marketplace and keeps it private only.',
          notesLabelDestructive: 'Action Notes',
          notesLabelApprove: 'Review Notes',
          placeholderApprove: 'Optional: record the review decision, requirements, or launch notes',
          placeholderReject: 'Enter the rejection reason, remediation advice, or risk explanation',
          placeholderDisable: 'Enter the disable reason, triggered rule, or governance basis',
          placeholderForcePrivate: 'Enter the force-private reason, risk points, or complaint clues',
          hintDestructive: 'For reject/disable/force-private actions, provide a traceable governance basis.',
          hintApprove: 'Notes will appear in the review log.',
          confirmApprove: 'Confirm Approval',
          confirmReject: 'Confirm Rejection',
          confirmDisable: 'Confirm Disable',
          confirmForcePrivate: 'Confirm Force Private',
          validationRequired: 'Please provide the governance basis before submitting.',
        },
      },
      runtime: {
        title: 'Skill Runtime',
        subtitle: 'Monitor live skill execution, queue pressure, and alert activity.',
        searchPlaceholder: 'Search by skill name, slug, or version',
        healthStatus: 'Health Status',
        summaryNote: 'Metrics are aggregated from real runtime data.',
        view: 'View',
        emptyTitle: 'No runtime metrics yet',
        emptyDescription: 'Runtime metrics, alerts, and queue details will appear here.',
        columns: {
        ...
        metrics: {
          ...
          requests24h: '24h Requests',
          totalSkills: 'Total skills {count}',
          averageSuccessRate: 'Average Success Rate',
          p95Latency: 'P95 Latency',
          criticalAlerts: 'Critical Alerts',
          requestsHint: 'Aggregated from the current filter window',
          warningCount: 'Warnings {count}',
          latencyHint: 'Prioritize queue and dependency checks when latency spikes',
          criticalHint: 'Handle user-facing outages first'
        },
        detail: {
          successRate: 'Success Rate',
          p95Latency: 'P95 Latency',
          ...
          queueDepth: 'Queue Depth',
          lastRunAt: 'Last Run',
          lastAlertAt: 'Last Alert',
          lastError: 'Last Error',
          noRecentError: 'This skill has no recent errors.',
          selectionPlaceholder: 'Select a runtime row to see latency, error, and queue metrics.',
          noSelection: 'Select a runtime row to see latency, error, and queue metrics.'
        },
        events: {
          title: 'Recent Alerts / Events',
          description: 'Global events are shown by default; selecting a skill prioritizes related events.',
      ...
      settlement: {
        title: 'Skill Settlement',
        searchPlaceholder: 'Search by skill name, author, or settlement period',
        status: 'Settlement Status',
        filterHint: 'Filter by settlement status to focus on payouts waiting for audit, ready for release, or already settled.',
        emptyTitle: 'No settlement records',
        emptyDesc: 'Skill settlement records will appear here after revenue is generated and enters the settlement cycle.',
        authorLabel: 'Author',
        periodTitle: 'Settlement Period',
        payoutTitle: 'Payout Amount',
        grossTitle: 'Gross Revenue',
        platformFeeTitle: 'Platform Fee',
        frozenTitle: 'Frozen Amount',
        updatedTitle: 'Last Updated',
        noteTitle: 'Settlement Note',
        noteEmpty: 'No settlement note recorded yet.',
        detailEmpty: 'Select a settlement row to view the payout, fees, timeline, and review note.',
        timelineTitle: 'Settlement Timeline',
        timelineDescription: 'Shows how revenue moves from accrual to audit, release readiness, and final settlement.',
        timelineEmpty: 'No settlement selected yet.',
        columns: {
          skill: 'Skill',
          author: 'Author',
          period: 'Period',
        ...
        metrics: {
          pendingAmount: 'Pending Payout',
          pendingHint: '{count} skills are waiting for settlement review or release readiness.',
          settledAmount: 'Settled Amount',
          settledHint: 'Revenue already released to creators.',
          frozenAmount: 'Frozen Amount',
          frozenHint: 'Revenue temporarily held due to audit, dispute, or risk review.',
          currency: 'Currency',
          currencyHint: 'Settlement totals are aggregated by the current settlement currency.',
        },
        labels: {
          pending: 'Pending',
          ready: 'Ready',
        ...
        timeline: {
          accrualTitle: 'Revenue Accrued',
          accrualDesc: 'Revenue for {period} has been aggregated into the settlement cycle.',
          auditTitle: 'Settlement Audit',
          auditDesc: 'The settlement record passed the review stage and is waiting for release readiness.',
          auditFrozenTitle: 'Settlement Frozen',
          auditFrozenDesc: 'The settlement is currently frozen pending manual review or resolution.',
          auditRejectedTitle: 'Settlement Rejected',
          auditRejectedDesc: 'The settlement was rejected during review.',
          readyTitle: 'Ready for Release',
          readyDesc: 'The settlement has passed review and can be included in creator payouts.',
          readyPendingTitle: 'Awaiting Release Readiness',
          readyPendingDesc: 'The settlement has not reached the release-ready stage yet.',
          settledTitle: 'Settlement Completed',
          settledDesc: 'The payout has been completed and recorded.',
          settledPendingTitle: 'Awaiting Final Settlement',
          settledPendingDesc: 'The payout has not been fully settled yet.',
        },
      }
    },
    card: {
    ...
    market: {
      title: 'Skill Market',
      subtitle: 'Browse marketplace skills, install them, inspect details, and prepare variables for later runs.',
      searchPlaceholder: 'Search by skill name, description, or tags',
      category: 'Category',
      priceMode: 'Pricing',
      ...
      uninstallSuccess: 'Skill uninstalled successfully',
      installedOnly: 'Installed',
      notInstalledOnly: 'Not Installed',
      sortLatest: 'Latest',
      sortPopular: 'Popular',
      sortRuns: 'Most Runs',
    ...
    installed: {
      ...
      subtitle: 'Focus on the skills you already installed so you can jump back into details, versions, and runs quickly.',
      emptyTitle: 'No installed skills yet',
      emptyDescription: 'Install a few skills from the market first.',
      installedOnly: 'Installed',
      notInstalledOnly: 'Not Installed'
    },
    my: {
      title: 'My Skills',
      subtitle: 'Manage the skills you created or published, then continue into versions, runs, and revenue.',
      total: 'Total Skills',
      publishedCount: 'Published',
      paidCount: 'Paid Skills',
      searchPlaceholder: 'Search by name, tags, or description',
      visibility: 'Visibility',
      emptyTitle: 'No skills yet',
      emptyDescription: 'Create your first skill, then come back to manage its versions, runs, and revenue.',
      statusDraft: 'Draft',
    ...
    labels: {
      typePromptChat: 'Prompt Chat',
      typePromptImage: 'Prompt Image',
      typeScript: 'Script',
      statusDraft: 'Draft',
      statusPublished: 'Published',
      statusArchived: 'Archived',
    ...
    editor: {
      ...
      create: 'Create Skill',
      edit: 'Edit Skill',
      subtitle: 'Supports prompt_chat, prompt_image, and script skills with configurable variable schemas.',
      namePlaceholder: 'Enter a skill name',
      nameRequired: 'Skill name is required',
      slug: 'Slug',
      slugPlaceholder: 'Used in URLs and unique identifiers, for example: marketing-copy-helper',
      slugRequired: 'Slug is required',
      tagline: 'Tagline',
      taglinePlaceholder: 'A short one-line summary of the skill',
      description: 'Description',
      descriptionPlaceholder: 'Explain what this skill does, who it is for, and what inputs or outputs it expects.',
      type: 'Type',
      ...
      priceAmount: 'Price',
      currency: 'Currency',
      sourceLocked: 'Hide Source Content',
      sourceLockedHint: 'When enabled, users can only see the variable form and metadata, not the source content.',
      coverImage: 'Cover Image',
      coverImagePlaceholder: 'Enter a cover image URL',
      extra: 'Extra Settings',
      readmePlaceholder: 'Add usage notes, examples, or maintenance instructions.',
      installNotePlaceholder: 'Add installation, setup, or onboarding notes.',
      sourceConfig: 'Source Content',
      systemPrompt: 'System Prompt',
      systemPromptPlaceholder: 'Define the role, constraints, and output requirements for this skill.',
      userPromptTemplate: 'User Prompt Template',
      userPromptTemplatePlaceholder: 'Reference variables with {{variable_name}}.',
      assistantPrefill: 'Assistant Prefill',
      assistantPrefillPlaceholder: 'Optional. Prefill the opening of the assistant response.',
      model: 'Model',
      modelPlaceholder: 'For example: gpt-4.1-mini',
      temperature: 'Temperature',
      maxTokens: 'Max Tokens',
      imagePromptTemplate: 'Image Prompt Template',
      imagePromptTemplatePlaceholder: 'Describe the subject, style, camera, materials, and lighting.',
      negativePromptTemplate: 'Negative Prompt Template',
      negativePromptTemplatePlaceholder: 'Optional. Describe what should be avoided.',
      style: 'Style',
      stylePlaceholder: 'For example: cinematic',
      size: 'Size',
      sizePlaceholder: 'For example: 1024x1024',
      quality: 'Quality',
      qualityPlaceholder: 'For example: high',
      imageCount: 'Image Count',
      language: 'Language',
      languagePlaceholder: 'For example: javascript',
      runtime: 'Runtime',
      runtimePlaceholder: 'For example: node20',
      entrypoint: 'Entrypoint',
      entrypointPlaceholder: 'For example: main.mjs',
      timeoutSeconds: 'Timeout (seconds)',
      dependencies: 'Dependencies',
      dependenciesPlaceholder: 'Comma-separated, for example: axios,lodash',
      sourceCode: 'Source Code',
      sourceCodePlaceholder: 'Enter the script source code here.',
      promptImageHint: 'Define the main image prompt, negative prompt, and default image parameters.',
      scriptHint: 'Script skills can configure the runtime, entrypoint, dependencies, and source code.',
      promptChatHint: 'Chat skills usually consist of a system prompt and a user prompt template.',
      required: 'Required',
      variableSchema: 'Variable Schema',
      variableSchemaHint: 'Paid skills only expose the variables defined here by default instead of showing the source content directly.',
      addVariable: 'Add Variable',
      untitledVariable: 'Untitled Variable',
      variableKey: 'Variable Key',
      variableKeyPlaceholder: 'For example: product_name',
      variableLabelPlaceholder: 'For example: Product Name',
      variableType: 'Variable Type',
      requiredFlag: 'Required',
      requiredFlagHint: 'This variable must be provided at runtime.',
      placeholder: 'Placeholder',
      placeholderValue: 'Input hint shown to users',
      defaultValue: 'Default Value',
      selectOptions: 'Select Options',
      selectOptionsHint: 'Define the labels and values shown in the dropdown.',
      addOption: 'Add Option',
      optionValue: 'Value',
      noVariables: 'No variables yet. This is suitable for fixed-function skills.'
    },
    detail: {
      title: 'Skill Detail',
      subtitle: 'Review the skill overview, exposed variables, version summary, and installation notes.',
      about: 'About',
      actionVersion: 'Active Version',
      readme: 'Readme',
      sourcePreview: 'Source Preview',
      sourceLocked: 'Source Hidden',
      sourceLockedNotice: 'This is a paid or protected skill, so its source content is hidden by default. Only the variable form and metadata are shown here.',
      exposedVariables: 'Configurable Variables',
      exposedVariablesHint: 'These variables are shown to users before they run or use the skill.',
      installNote: 'Installation Notes',
      meta: 'Metadata',
      latestVersion: 'Latest Version'
    },
    form: {
      booleanToggle: 'Enable this option',
      noVariables: 'No variables to fill in.'
    },
    versions: {
      title: 'Version Management',
      subtitle: 'Manage release cadence, changelogs, the current version, and visibility.',
      recent: 'Recent Versions',
      createVersion: 'Create Version',
      createVersionHint: 'By default, a version snapshot is created from the current skill content and variable schema.',
      version: 'Version',
      versionRequired: 'Version number is required',
      changelog: 'Changelog',
      changelogPlaceholder: 'Describe what changed in this version.',
      publishVersion: 'Create Version',
      currentVersion: 'Current Version',
      noChangelog: 'No changelog provided',
      emptyTitle: 'No versions yet',
      emptyDescription: 'Create the first version from the current skill snapshot.',
      sourceLockedHint: 'At the version level, you can also choose whether to expose the source content.',
      statusDeprecated: 'Deprecated'
    },
    runs: {
      title: 'Run History',
      subtitle: 'Inspect recent executions, statuses, latency, and output summaries for a skill.',
      searchPlaceholder: 'Search by trigger, version, input, or output',
      trigger: 'Trigger',
      duration: 'Duration',
      cost: 'Cost',
    ...
    revenue: {
      title: 'Revenue',
      subtitle: 'Review sales and execution revenue, along with the related order details.',
      ...
      trend: 'Revenue Trend',
      trendHint: 'Track how this skill is performing over time.',
      emptyTrendTitle: 'No revenue data yet',
      emptyTrendDescription: 'Revenue charts will appear after this skill starts generating sales or runs.',
      orders: 'Orders',
      ordersHint: 'Recent sales and settlement-related order details.',
      buyer: 'Buyer',
      amount: 'Amount'
    }
  },
  ...
  usage: {
    ...
    imageSubtotal: 'Image subtotal',
    tokenSubtotal: 'Token subtotal',
    rowTotal: 'Row total',
    imageCount: 'Image count',
    cacheRead: 'Read',
    cacheWrite: 'Write',
  ...
  admin: {
    ...
    dashboard: {
      ...
      todayCost: 'Today Cost',
      totalCost: 'Total Cost',
      balanceConsumption: 'Balance Spend',
      subscriptionConsumption: 'Subscription Spend',
    ...
    backup: {
      ...
      s3: {
        ...
        addProfile: 'Add Storage',
        profile: 'Storage Profile',
        profileName: 'Profile Name',
        profileRequired: 'Add at least one storage profile first',
        provider: 'Provider',
        endpoint: 'Endpoint',
        region: 'Region',
        bucket: 'Bucket',
        ...
        backupTitle: 'Backup Storage',
        backupProfile: 'Backup Profile',
        backupProfileRequired: 'Select a backup profile',
        selectProfile: 'Select a profile',
        mediaTitle: 'Media Uploads',
        mediaDescription: 'Use the same object storage for invoice files, avatars, announcements, tickets, and other media uploads.',
        mediaEnabled: 'Enable Media Storage',
        mediaProfile: 'Media Profile',
        mediaProfileRequired: 'Select a media profile when media storage is enabled',
        mediaPublicBaseURL: 'Media Public Base URL',
        mediaPublicBaseURLRequired: 'Media public base URL is required when media storage is enabled',
    ...
    users: {
      ...
      todaySubscription: 'Today subscription',
      last30Days: 'Last 30 days',
    ...
    groups: {
      ...
      openaiTypeRequired: 'Select at least one image route',
      tier1k: '1K',
      tier2k: '2K',
      tier4k: '4K',
      tier1kPrice: '1K ($)',
    ...
    riskControl: {
      ...
      apiKeysPlaceholder: "Add API Keys, one per line. Use sk-... email{'@'}example.com to attach an account email. They will be appended on save.",
      apiKeysPlaceholderReplace: "Replace API Keys, one per line. Use sk-... email{'@'}example.com to attach an account email. Stored keys will be replaced on save.",
      apiKeysPlaceholderKeep: "Add API Keys, one per line. Use sk-... email{'@'}example.com to attach an account email. They will be appended on save.",
      ...
      apiKeyRateLimitPolicy: 'Audit Key Rate-Limit Failure',
      apiKeyRateLimitPolicyHint: 'Applied when all audit keys are locally rate-limited or upstream returns 429. Error blocks pre-block requests; Allow lets the original request continue.',
      apiKeyRateLimitPolicyError: 'Mark error and return to client',
      apiKeyRateLimitPolicyAllow: 'Allow original request',
      apiKeyRPMLimit: 'Per-key RPM limit',
      apiKeyRPDLimit: 'Per-key RPD limit',
      apiKeyTPMLimit: 'Per-key TPM limit',
      apiKeyLocalUsage: 'Local usage RPM {rpm} / RPD {rpd} / TPM {tpm}',
      ...
      recordAttentionInputs: 'Enable Attention Threshold Recording',
      recordAttentionInputsHint: 'When a non-hit reaches this highest-score threshold, store it as a non-hit summary only. It does not trigger hits, bans, or blocking.',
      attentionThreshold: 'Attention Threshold',
      attentionThresholdInvalid: 'When attention threshold recording is enabled, the threshold must be greater than 0 and less than or equal to 100.',
      ...
      autoBanExemptUsers: 'Auto-Ban Exempt Users',
      autoBanExemptUsersPlaceholder: "One user ID or email per line\n1001\nvip{'@'}example.com",
      autoBanExemptUsersSearchPlaceholder: 'Search users by email or ID',
      autoBanExemptUserUnknownEmail: 'unknown email',
      autoBanExemptUsersHint: 'These users are still blocked and emailed on hits, but are not automatically disabled.',
      ...
      blockedKeywordsPlaceholder: 'One keyword or rule per line, e.g.:\nbadword1\nfull risky phrase\naccount && sale',
      blockedKeywordsDescription: 'Matching is case-insensitive. Use && on one line when all terms must appear before the rule hits. Whether the upstream moderation API is invoked after a hit depends on the strategy below.',
    ...
    channelMonitor: {
      ...
      adjustAvailability: {
        action: 'Fix 7d',
        title: 'Adjust 7d Availability',
        current: 'Current: {value}',
        target: 'Target availability',
        placeholder: '0 - 100',
        hint: 'This directly adjusts primary-model history rows in the last 7 days. The final value may be approximate because it is limited by the number of samples.',
        submit: 'Apply',
        invalid: 'Availability must be between 0 and 100',
        failed: 'Failed to adjust availability',
        success: 'Availability adjusted to {value}; changed {rows} history rows'
      },
      columns: {
        name: 'Name',
        provider: 'Provider',
    ...
    accounts: {
      ...
      dataImportDedupMode: 'Deduplication',
      dataImportDedupNone: 'Do not deduplicate',
      dataImportDedupOverwrite: 'Deduplicate and overwrite',
      ...
      accountNameOAuthPlaceholder: 'Optional for OAuth; auto uses email (profile_id) when available',
      ...
      openai: {
        ...
        textEndpointAutoRoute: 'Auto-route text endpoints',
        textEndpointAutoRouteDesc:
          'Allows Responses, Messages, and Chat Completions text ingress to convert to the text upstream endpoint this account can use. Use it for chat-only upstreams serving Codex /responses or /messages requests.',
      ...
      invalidModelMapping:
        'Model mapping contains an invalid row: request and target models are required, wildcard * is only allowed at the end of the request model, and target model cannot contain wildcards.',
      ...
      syncUpstreamModelsNoChanges: 'Upstream models are already synced',
      syncUpstreamModelsFailed: 'Failed to sync upstream models',
      syncUpstreamModelsError: 'Unable to sync upstream models',
      ...
      oauth: {
        ...
        // Gemini specific
	        gemini: {
	          ...
	          projectIdHint:
	            'This is your own string-based Google Cloud Project ID, not the upstream auto-assigned companion project. In Google One flows you usually leave it empty and let Google auto-detect. If auto-detection fails and you already have a usable Project ID, fill it in and re-generate the auth URL to try again.',
	          ...
	          projectTipStepIam:
	            'Grant the current account these IAM roles: Gemini Cloud Assist User (Beta), Gemini Code Assist Tools User (Beta), and Owner.',
	          projectTipStepApi: 'Enable cloudaicompanion.googleapis.com in that project.',
	          projectConsoleLink: 'Open Google Cloud Console',
	          projectApiLink: 'Enable Cloud AI Companion API',
	          projectIdRecoveryTitle: 'Manually fill Project ID after auto-detection fails',
	          projectIdRecoveryDesc:
	            'Enter the prepared Project ID, regenerate the authorization URL, and complete Google authorization again.',
	          projectIdChangedRegenerate:
	            'Project ID was changed after this authorization URL was generated. Regenerate the authorization URL before exchanging the code.',
          ...
          confirmRedirectUri:
            'I have configured this Redirect URI in the Google OAuth client (must match exactly)',
	          ...
	          googleOneUserDefinedProjectRequired: 'Google One authorization succeeded, but the upstream tier explicitly requires a user-defined Project ID. Google did not auto-return a companion project for this account in this OAuth flow.',
	          googleOneProjectDetectionFailed: 'Google One authorization succeeded, but the upstream companion project could not be detected. Retry the authorization once. If it still fails and you already have a usable Google Cloud Project ID, fill it in step 4, regenerate the authorization URL, and retry.',
	          codeAssistAgeVerificationRequired: 'Gemini authorization failed because Google still reports this account as age-restricted or not yet age-verified.',
	          ineligibleTier: 'Gemini authorization failed because this Google account is not eligible for the selected OAuth tier.',
	          eligibilityGuidanceTitle: 'Why this failed and what to do',
	          ineligibleTierGuidanceTitle: 'Eligibility check failed',
	          eligibilityAgeReason:
	            "Reason: the upstream eligibility check still reports this Google account as age-restricted or not yet age-verified. If you already completed age verification, the most likely causes are using a different Google account in the OAuth window or Google's eligibility state not having synced yet.",
	          ineligibleTierReason:
	            'Reason: the upstream Gemini OAuth flow accepted the login, but the Google account is not eligible for the selected Gemini tier. This is an upstream account-status problem rather than a local request formatting problem.',
	          eligibilityStepCheckAccount:
	            'Check the Google account profile and eligibility status, and make sure you are authorizing the intended Google account.',
	          eligibilityAgeStepRetryAuth:
	            'If you have already completed age verification, sign out of Google, sign back in with the same personal account in the OAuth window, wait for the upstream status to sync, then generate a new authorization URL and retry.',
	          eligibilityAgeStepTryOtherFlow:
	            'If the same Google One account still fails after retrying, use a different eligible personal Google account instead of continuing with the current one.',
	          eligibilityGenericStepRetryAuth:
	            'Sign out of Google, sign back in with the exact intended account in the OAuth window, then retry once to rule out account switching or stale upstream session state.',
	          eligibilityGenericStepTryOtherFlow:
	            'If it still fails, check upstream restrictions such as account type, workspace policy, supported country, and network environment. If needed, switch to another eligible Google account instead of continuing with the current one.',
	          eligibilityAgeNotGcpRelated:
	            'This error is not caused by missing GCP Project ID, IAM roles, or Cloud AI Companion API. Those GCP setup links below are only for project bootstrap and project_id recovery issues.',
          ...
          googleOneDesc:
            'Personal Gemini OAuth. Leave Project ID empty by default; if companion-project auto-detection fails, you can fill it and regenerate the authorization URL.',
          cannotInferOAuthType:
            'Could not infer the Gemini OAuth type from this account. Fix the stored oauth_type/tier metadata or recreate the account before reauthorizing.',
          ...
          codeAssistRequirement: 'Requires an activated GCP project and a billing-enabled card on the project.',
          ...
          noProjectIdNeededDesc: 'Requires admin-configured OAuth client',
	          legacyCustomOAuthRemoved: 'Legacy AI Studio OAuth has been removed',
	          legacyCustomOAuthRemovedDesc:
	            'The custom OAuth Client entry has been removed. Legacy AI Studio OAuth accounts can no longer be re-authorized. Use a Gemini API Key account instead, or create a new Google One / GCP Code Assist OAuth account.',
      ...
      kiro: {
        ...
        authMethodHint: 'Social fits normal Kiro accounts. IDC requires extra AWS/IDC client fields.',
        ...
        quotaPartSummary: '${used}/${limit} · left ${remaining}',
        monthlyQuota: 'Monthly',
        bonusQuota: 'Bonus',
        freeTrialQuota: 'Trial'
      },
      // Test Modal
      ...
      imageTestRouteLabel: 'Test route',
      imageTestRouteHint: 'OpenAI image tests use codex.',
      imageTestRouteOptionCodex: 'codex',
      ...
      inviteResetOpenDialog: 'Open invite reset dialog',
      inviteResetCountShort: 'Resets',
      inviteResetQuery: 'Query',
      inviteResetReset: 'Reset',
      ...
      inviteResetHistoryTitle: 'History',
      inviteResetHistoryEmpty: 'No invite/reset records yet',
      inviteResetHistoryActionInvite: 'Invite',
      inviteResetHistoryActionConsume: 'Reset',
      inviteResetHistorySuccess: 'Success',
      inviteResetHistoryFailed: 'Failed',
      inviteResetHistoryFailedEmails: 'Failed emails: {emails}',
      tier: {
        free: 'Free',
        pro: 'Pro',
        ultra: 'Ultra',
    ...
    redeem: {
      ...
      failedToBatchUpdate: 'Failed to batch update codes',
      ...
      expiryPresetDays: '{days} day(s)',
      expiryDaysRequired: 'Please enter a valid expiry time',
      groupRequired: 'Please select a subscription group',
      days: ' days',
      batchNotesPlaceholder: 'Enter notes',
      batchFields: {
        status: 'Status',
    ...
    ops: {
      ...
      systemLogs: {
        ...
        saveConfigSuccess: 'Runtime log configuration applied',
        saveConfigFailed: 'Failed to save log configuration',
        resetConfirm: 'Revert to startup configuration (env/yaml) and apply immediately?',
        resetConfigSuccess: 'Reverted to startup log configuration',
        resetConfigFailed: 'Failed to revert log configuration',
        ...
        runtime: {
          title: 'Runtime Log Configuration (applies immediately)',
          level: 'Level',
        ...
        actions: {
          query: 'Query',
          cleanupFiltered: 'Clean Up Filtered Logs',
      ...
      settings: {
        ...
        ignoreCredential401Errors: 'Ignore credential 401 errors',
        ignoreCredential401ErrorsHint: 'When enabled, 401 credential-expired or authentication-failed errors will not be written to the error log.',
        ignoreRateLimit429Errors: 'Ignore 429 rate limit errors',
        ignoreRateLimit429ErrorsHint: 'When enabled, 429 rate limit errors will not be written to the error log.',
        ignoreAccountNotFoundErrors: 'Ignore account not found errors',
        ignoreAccountNotFoundErrorsHint: 'When enabled, account not found errors will not be written to the error log. Useful for scheduled test noise.',
        autoRefresh: 'Auto Refresh',
        enableAutoRefresh: 'Enable auto refresh',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          rebateCap: 'Affiliate Rebate Cap',
          rebateCapHint: 'Maximum rebate amount generated per recharge. 0 means no cap.',
          inviteeLimit: 'Per-Inviter Invitee Limit',
          inviteeLimitHint: 'Maximum invitees counted for rebate. 0 means unlimited.',
          signupBonus: 'Invitee Signup Bonus',
          signupBonusHint: 'Bonus credited to the invitee after successful signup. 0 means disabled.',
      ...
      emailTemplates: {
        ...
        localeEn: 'English',
        localeZh: 'Chinese',
        empty: 'No email template options are available.',
        subject: 'Subject',
        ...
        previewSecurityHint: 'Preview is sandboxed in the browser and does not execute scripts.',
        validationRequired: 'Subject and HTML are required.',
        saveSuccess: 'Email template saved.',
        restoreConfirm: 'Restore this template to the official default?',
      ...
      gatewayForwarding: {
        ...
        debugTimelineDirectoryHint: 'Relative paths are resolved from the service working directory; files are named gateway-timeline-YYYY-MM-DD.log.',
        debugTimelineRetentionDays: 'Retention Days',
        debugTimelineMaxSizeMB: 'Max Size MB',
        debugTimelineIncludeBody: 'Capture request/response bodies',
        debugTimelineIncludeBodyHint: 'Applies to Claude and Kiro only. When enabled, the timeline records the client request body, upstream request body, and upstream response body (aggregated for streams) to help diagnose tool calls, fake-cache plans, etc. Sensitive fields such as Authorization, refresh_token, and client_secret are redacted automatically.',
        debugTimelineBodyMaxKB: 'Body cap (KB)',
        debugTimelineBodyMaxKBHint: 'Bodies larger than this size are truncated and flagged with body_truncated. Default 32KB, max 1024KB.',
      ...
      authSourceDefaults: {
        ...
        description: 'Configure extra balance, concurrency, and subscriptions per third-party auth source. When enabled, new users who register through that source receive these extras on top of the user defaults. If “Also grant on first bind” is enabled, existing users receive the same extras the first time they bind that source. Each source only grants once per user.',
        ...
        enabledLabel: 'Enable source bonus grant',
        enabledHint: 'When enabled, new users who sign up through this source receive the configured extras.',
        grantOnFirstBindLabel: 'Also grant on first bind',
        grantOnFirstBindHint: 'When enabled, existing users receive the same extras the first time they bind this source. When disabled, only new signups through this source receive them.',
        bonusBalanceLabel: 'Bonus balance',
        bonusConcurrencyLabel: 'Bonus concurrency',
        defaultSubscriptionsLabel: 'Bonus subscriptions',
        defaultSubscriptionsHint: 'Applies only to this auth source and stacks with user default subscriptions.',
        addBonusSubscription: 'Add bonus subscription',
        subscriptionGroupLabel: 'Subscription group',
        noSourceSubscriptions: 'No bonus subscriptions configured for this source.',
    ...
    tlsFingerprintProfiles: {
      ...
      form: {
        ...
        userAgent: 'User-Agent',
        userAgentPlaceholder: 'e.g. codex_exec/0.141.0 (Ubuntu 24.4.0; x86_64) WindowsTerminal',
        userAgentHint: 'Optional. When set, OpenAI requests using this TLS profile will use this upstream User-Agent; otherwise passthrough and OpenAI Codex UA fallback rules apply.',
    ...
    // TLS Fingerprint Routers
    tlsFingerprintRouters: {
      title: 'TLS Fingerprint Routers',
      description: 'Route inbound OpenAI User-Agent patterns to TLS fingerprint profiles and optional upstream headers',
      createRouter: 'Create Router',
      editRouter: 'Edit Router',
      deleteRouter: 'Delete Router',
      noRouters: 'No routers configured',
      createFirstRouter: 'Create your first TLS fingerprint router',
      ...
      form: {
        name: 'Router Name',
        namePlaceholder: 'e.g. OpenAI User-Agent Router',
        description: 'Description',
        descriptionPlaceholder: 'Optional description for this router',
        enabled: 'Enable Router',
        enabledHint: 'Disabled routers are ignored by account routing',
        rules: 'Rules',
        addRule: 'Add Rule',
        ...
        profile: 'TLS Fingerprint Profile',
        selectProfile: 'Select profile',
        caseSensitive: 'Case sensitive',
        upstreamUserAgent: 'Upstream User-Agent',
        upstreamUserAgentPlaceholder: 'Optional replacement User-Agent',
        upstreamOriginator: 'Upstream Originator',
        upstreamOriginatorPlaceholder: 'Optional originator value'
      },

      deleteConfirmMessage: 'Are you sure you want to delete router "{name}"? Accounts using this router will stop routing by TLS fingerprint rules.',
      createSuccess: 'Router created successfully',
      updateSuccess: 'Router updated successfully',
      ...
      toggleFailed: 'Failed to toggle router'
    }
  },
  ...
  payment: {
    ...
    invoice: {
      ...
      detailPage: {
        ...
        fileWaiting: 'Waiting for accounting to issue the invoice',
      },
      create: {
        action: 'Apply for invoice',
        selected: '{count} order(s) selected',
        totalAmount: 'Total',
        submit: 'Submit',
        submitting: 'Submitting…',
        success: 'Invoice request submitted',
        allSuccess: 'Invoice request submitted',
        clearSelection: 'Clear selection',
        maxExceeded: 'At most 100 orders per invoice',
      },
      list: {
        title: 'My Invoices',
        empty: 'No invoices',
        colOrderCount: 'Orders',
        searchPlaceholder: 'Search by id, title, email, order no…',
      },
      errors: {
        INVOICE_ORDER_INELIGIBLE: 'Some orders are not eligible. Please refresh and retry.',
        INVOICE_ALREADY_INVOICED: 'Order is already in another invoice',
        INVOICE_BATCH_TOO_MANY: 'At most 100 orders per invoice',
        INVOICE_CANNOT_CANCEL: 'Invoice cannot be cancelled in current state',
        INVOICE_CANNOT_UPLOAD: 'Invoice cannot be uploaded in current state',
        INVOICE_NOT_ISSUED: 'Invoice has not been issued',
        INVOICE_DISABLED: 'Invoice not available for this order',
        INVOICE_TITLE_REQUIRED: 'Title is required',
        ...
        INVOICE_SERVICE_UNAVAILABLE: 'Invoice service unavailable',
      },
    },
    ...
    admin: {
      ...
      invoiceRefundAppliedWarning: 'This order has an invoice application. Refunding will cancel the invoice application; confirm before continuing.',
      invoiceRefundIssuedWarning: 'This order has an issued invoice. Refunding requires a credit note/manual finance handling; confirm before continuing.',
